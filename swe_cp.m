...
if ~isMat
    ...
    for i = 1:nBeta
        Vbeta(i) = swe_create_vol([sprintf('swe_vox_beta_b%02d',i) file_ext],...
                                  DIM, M,...
    ...
    for i=1:nBeta
        for ii=i:nBeta
            it=it+1;
            Vcov_beta(it) = swe_create_vol([sprintf('swe_vox_cov_b%02d_b%02d',i,ii) file_ext],...
    ...
    %----------------------------------------------------------------------
    % for i = 1:nSres
    %     VResI(i) = swe_create_vol(sprintf('ResI_%02d.img', i),...
