...
% ====================================================================
% Compute a specified and thresholded SwE parametric map for 
% the SwE method.
%
% ====================================================================
...
%   '\n - swe_vox_mask: Mask image generated by the parametric inference.'
%   '\n - swe_vox_{T|F}stat_c01: Unthresholded parametric T/F statistic map.'
%   '\n - swe_vox_{zT|xF}stat_c01: Parametric Z/F score map derived from T/F statistics.'
%   '\n - swe_vox_{zT|xF}stat-WB_c01: Wild bootstrap Z/F score map derived from T/F statistics.' 
%   '\n - swe_vox_{T|F}stat_lp-WB_c{c#}: Images of -log10(voxel-wise uncorrected non-parametric P-values, c#=1 for positive and c#=2 negative.)'
%   '\n - swe_vox_{T|F}stat_lpFWE-WB_c{c#}: Images of -log10(voxel-wise FWE-corrected non-parametric P-values, c#=1 for positive and c#=2 negative). Here, FWE-corrected non-parametric P-values are the proportion of the wild bootstrap distribution for the maximal statistic which exceeds the statistic image at the voxel.'
%   '\n - swe_vox_{T|F}stat_lpFDR-WB_c{c#}: Images of -log10(voxel-wise FDR-corrected non-parametric P-values, c#=1 for positive and c#=2 negative). They are computed based by applying BH-fdr correction on lP+ & lP-.'
%   '\n - swe_clustere_{T|F}stat_lpFWE-WB_c{c#}: Images of -log10(cluster-wise FWE-corrected non-parametric P-values, c#=1 for positive and c#=2 negative). Note that, the -log10(p-values) of each formed cluster is repeated at each voxel belonging to this cluster. More information about the formed cluters can be found in the "SwE.mat" file in the field SwE.WB.clusterInfo.'
%   '%s'};
