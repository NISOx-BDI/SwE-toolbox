...
classdef test_swe_run < matlab.unittest.TestCase
    ...
    methods(Test)
        ...
        function test_blah_runs(testCase)
            ...
            design.WB.WB_yes.WB_ss = 3;
            design.WB.WB_yes.WB_nB = 100;
            design.WB.WB_yes.WB_SwE = 0;
            design.WB.WB_yes.WB_stat.WB_F.WB_F_con = eye(3);
            ...
            % Save the design as an swe matlabbatch.
            matlabbatch{1}.swe.design = design;
