...
if ~isMat
  ...
  for i = 1:nScan
    VResWB(i).fname   = sprintf('ResWB_%04d.img', i);
    if WB.RWB == 1
  ...
  for i = 1:nScan
    VYWB(i).fname   = sprintf('YfittedWB_%04d.img', i);
    if WB.RWB == 1
  ...
  %----------------------------------------------------------------------
  VlP_wb_pos = deal(struct(...
    'fname',    'swe_vox_lp-WB_c0001.img',...
    'dim',      DIM',...
    'dt',       [spm_type('float32') spm_platform('bigend')],...
    'mat',      M,...
    'pinfo',    [1 0 0]',...
    'descrip',  '-log10(uncor. non-para. P, +ve)'));
  VlP_wb_pos = spm_create_vol(VlP_wb_pos);
  
  VlP_wb_FWE_pos = deal(struct(...
    'fname',    'swe_vox_lpFWE-WB_c0001.img',...
    'dim',      DIM',...
    'dt',       [spm_type('float32') spm_platform('bigend')],...
    'mat',      M,...
    'pinfo',    [1 0 0]',...
    'descrip',  '-log10(FWE-corr. P, +ve)'));
  VlP_wb_FWE_pos = spm_create_vol(VlP_wb_FWE_pos);
  
  VlP_wb_FDR_pos = deal(struct(...
    'fname',    'swe_vox_lpFDR-WB_c0001.img',...
    'dim',      DIM',...
    'dt',       [spm_type('float32') spm_platform('bigend')],...
    'mat',      M,...
    'pinfo',    [1 0 0]',...
    'descrip',  '-log10(FDR-corr. P, +ve)'));
  VlP_wb_FDR_pos=spm_create_vol(VlP_wb_FDR_pos);
  
  if WB.stat=='T'
    VlP_wb_neg = deal(struct(...
      'fname',    'swe_vox_lp-WB_c0001neg.img',...
      'dim',      DIM',...
      'dt',       [spm_type('float32') spm_platform('bigend')],...
      'mat',      M,...
      'pinfo',    [1 0 0]',...
      'descrip',  '-log10(uncor. non-para. P, -ve)'));
    VlP_wb_neg=spm_create_vol(VlP_wb_neg);
    
    VlP_wb_FWE_neg = deal(struct(...
      'fname',    'swe_vox_lpFWE-WB_c0001neg.img',...
      'dim',      DIM',...
      'dt',       [spm_type('float32') spm_platform('bigend')],...
      'mat',      M,...
      'pinfo',    [1 0 0]',...
      'descrip',  '-log10(FWE-corr. P, -ve)'));
    VlP_wb_FWE_neg = spm_create_vol(VlP_wb_FWE_neg);
    
    VlP_wb_FDR_neg = deal(struct(...
      'fname',    'swe_vox_lpFDR-WB_c0001neg.img',...
      'dim',      DIM',...
      'dt',       [spm_type('float32') spm_platform('bigend')],...
      'mat',      M,...
      'pinfo',    [1 0 0]',...
  ...
  if WB.clusterWise == 1
    VlP_wb_clusterFWE_pos = deal(struct(...
      'fname',    'swe_clus_lpFWE-WB_c0001.img',...
      'dim',      DIM',...
      'dt',       [spm_type('float32') spm_platform('bigend')],...
      'mat',      M,...
      'pinfo',    [1 0 0]',...
      'descrip',  '-log10(clusterFWE-corr. P, +ve)'));
    VlP_wb_clusterFWE_pos = spm_create_vol(VlP_wb_clusterFWE_pos);
    
    if WB.stat=='T'
      VlP_wb_clusterFWE_neg = deal(struct(...
        'fname',    'swe_clus_lpFWE-WB_c0001neg.img',...
        'dim',      DIM',...
        'dt',       [spm_type('float32') spm_platform('bigend')],...
        'mat',      M,...
        'pinfo',    [1 0 0]',...
        'descrip',  '-log10(clusterFWE-corr. P, -ve)'));
      VlP_wb_clusterFWE_neg = spm_create_vol(VlP_wb_clusterFWE_neg);
    end
  end
