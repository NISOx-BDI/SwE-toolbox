...
files = {'^swe_vox_mask\..{3}$',...
        ...
        '^swe_clustere_\w{1,2}stat-lp\w{0,3}_c\d{2}\..{3}$',...
        '^swe_vox_\w{1,2}stat-WB_c\d{2}\..{3}$',...
        '^swe_vox_\w{1,2}stat_lp\w{0,3}-WB_c\d{2}\..{3}$',...
        '^swe_clustere_\w{1,2}stat-WB_c\d{2}\..{3}$',...
        '^swe_clustere_\w{1,2}stat_lp\w{0,3}-WB_c\d{2}\..{3}$',...
